 ...
 *
 *<p>
 * Imagina que estás trabajando en un sistema de reservas
 * de asientos para un teatro. Crea un programa en Java que
 * represente un mapa de asientos en una matriz de 5x5 y ten
 * en cuenta lo siguiente:
 * <ul>
 *     <li>Los asientos pueden estar ocupados (representados por "X")
 *     o vacíos (representados por "O").</li>
 *     <li>Permite al usuario ingresar por teclado donde quiere sentarse,
 *     indicando su fila y número de asiento (por ejemplo, "Fila 3, Asiento 2").
 *     El programa debe marcar como ocupado ese asiento solo en caso de que esté vacío.</li>
